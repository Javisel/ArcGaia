package com.javisel.arcgaia.client.renderer;
...
@OnlyIn(Dist.CLIENT)
public  class LightningArrowRenderer<T extends LightningArrowEntity> extends EntityRenderer<T> {


    private static final ResourceLocation LIGHTNING_ARROW_TEXTURES = new ResourceLocation(MODID,"assets/textures/entity/lightning_arrow/lightning_arrow.png");
    ...
    public ResourceLocation getEntityTexture(T entity) {
        return LIGHTNING_ARROW_TEXTURES;
    }
    ...
    public static class RenderFactory implements IRenderFactory<Entity> {
        ...
        public EntityRenderer<? super Entity> createRenderFor(EntityRendererManager manager) {
            ...
            final LightningArrowRenderer lightningArrowRenderer = new LightningArrowRenderer(manager);
            return lightningArrowRenderer;
        }
